...
+!plan_case(Case)
  ...
  <- .send(runtime_coordinator, tell, activated_plan(Case, gdpr_breach_notification_plan));
...
+!plan_case(Case)
  ...
  <- .send(runtime_coordinator, tell, activated_plan(Case, gdpr_missing_legal_basis_plan));
...
+!plan_case(Case)
  ...
  <- .send(runtime_coordinator, tell, activated_plan(Case, gdpr_special_category_plan));
...
+!plan_case(Case)
  ...
  <- .send(runtime_coordinator, tell, activated_plan(Case, gdpr_lawful_processing_plan));
